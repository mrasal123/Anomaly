...
def get_connection_params():
    ...
    """
    SNOWFLAKE_ACCOUNT = os.getenv("yadipfj-sm64157")
    SNOWFLAKE_HOST = os.getenv("sm64157")
    SNOWFLAKE_DATABASE = os.getenv("STREAMLIT_DB")
    SNOWFLAKE_SCHEMA = os.getenv("STREAMLIT_SCHEMA")
    SNOWFLAKE_WAREHOUSE = os.getenv("WH_YML")
